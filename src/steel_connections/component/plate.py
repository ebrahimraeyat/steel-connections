...
from steel_connections.member.material import calc_mat_prop
...
class Plate():
    ...
    """
    standard_thickness = [0.6, 0.8, 1, 1.2, 1.5, 2, 2.5, 3]
    b_i: int = 200
    h_i: int = 200
    t_i: int = 10
    ...
    @property
    def I_p(self):
        return self.b_i * self.t_i ** 3 / 12
    
    @property
    def A_p(self):
        return self.b_i * self.t_i
    
    @property
    def A_g(self):
        return self.h_i * self.t_i
    
    @property
    def r_p(self):
        return math.sqrt(self.I_p / self.A_p)
