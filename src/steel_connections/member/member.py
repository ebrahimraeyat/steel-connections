...
from steel_connections.data.io import get_section_from_library, MemberLibrary
from steel_connections.member.material import SteelMaterial
from steel_connections.member.geometry import SectionGeometry
from steel_connections.member.slenderness import SteelSlenderness
from steel_connections.data.io import report
...
class SteelSection:
    ...
    def weight_per_length(self):
        return self.geom.A_g / 1e4 * 7850  #  kg/m
