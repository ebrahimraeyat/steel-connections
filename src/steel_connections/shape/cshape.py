...
def Z_x(params: dict) -> float:
    ...
    b_w=params.d-2*params.t_f
    Z_x =2*(params.t_w*(b_w/2)**2/2+params.t_f*params.b*(params.d/2-params.t_f/2)) + 2*  (1-math.pi/4)*params.r_1**2*(0.776*params.r_1 - params.r_1 +params.d/2 - params.t_f)
    return Z_x
...
def Z_y(params: dict) -> float:
    ...
    if x_cur>params.t_w:
        ...
        Z_y = params.t_f * b_f**2/2 + params.b * params.d * params.t_w/2 - params.d**2 * params.t_w**2/8/params.t_f 
    else:
        Z_y = 1/(4*params.d)*(4*params.t_f*params.b**2*(params.d-params.t_f)+params.t_w**2*(params.d**2-4*params.t_f**2)-4*params.b*params.t_f*b_w*params.t_w)
    ...
    Z_y_extra = 2*  (1-math.pi/4)*params.r_1**2 *x_fillet
    Z_y = Z_y + Z_y_extra
    return Z_y
