...
def Z_x(params: dict) -> float:
    '''Plastic section modulus - major axis'''
    t_w = params.t
    t_f = params.t
    Z_x = 2*(((params.d-2*params.r_o)/2)**2 * t_w + t_f*(params.b-2*params.r_o)*(params.d-t_f)/2) +4*(math.pi*params.r_o**2/4*(params.d/2+4/3/math.pi*params.r_o-params.r_o))-4*(math.pi*(params.r_o-params.t)**2/4*(params.d/2-t_w+4/3/math.pi*(params.r_o-params.t)-(params.r_o-params.t)))
    return Z_x

def Z_y(params: dict) -> float:
    '''Plastic section modulus - minor axis'''
    t_w = params.t
    t_f = params.t
    Z_y = 2*(t_w*(params.d-2*params.r_o)*(params.b-t_w)/2 + t_f*(params.b/2-params.r_o)**2)+4*(math.pi*params.r_o**2/4*(params.b/2+4/3/math.pi*params.r_o-params.r_o))-4*(math.pi*(params.r_o-params.t)**2/4*(params.b/2-t_w+4/3/math.pi*(params.r_o-params.t)-(params.r_o-params.t)))
    return Z_y
...
def main():
    ...
    from steel_connections.member.geometry import SectionGeometry    
