...
def Z_x(params: dict) -> float:
    ...
    if params.t_f < A_g(params)/(2*params.b):
        ...
        Z_x = params.t_w * (params.d-params.t_f)**2/4 + \
            params.b * params.d * params.t_f / 2 - \
            params.b**2*params.t_f**2/(4*params.t_w)
    else:
        Z_x =  params.t_w * params.d**2/2 + params.b * params.t_f **2/4 - \
...
def Z_y(params: dict) -> float:
    ...
    b_w=(params.d-params.t_f)
    r_1 = 0 if math.isnan(params.r_1) else params.r_1
    Z_y =2*b_w*(params.t_w/2)**2/2 + 2*params.t_f*(params.b/2)**2/2+ 2*  (1-math.pi/4)*r_1**2*(-0.776*r_1 + r_1 +params.t_w/2)
    return Z_y
